...
// the /srv/notify/ prefix, so the bare path is /.well-known/oauth-protected-resource.
...
// handleWhoami is the notify_whoami proof the dashboard's connect skill uses to
