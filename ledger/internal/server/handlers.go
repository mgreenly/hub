...
// the /srv/ledger/ prefix, so the bare path is /.well-known/oauth-protected-resource.
...
// handleWhoami is the ledger_whoami proof the dashboard's connect skill uses to
