...
const (
	testResourceID = "https://ai.metaspot.org/srv/crm/mcp"
...
func TestNewRequiresConfig(t *testing.T) {
	...
	cases := []struct {
		...
		{"no logger", Options{ResourceID: testResourceID, AuthServer: testAuthServer, MCP: stub, Feed: stub}},
		{"no resource", Options{Logger: logger, AuthServer: testAuthServer, MCP: stub, Feed: stub}},
		{"no auth server", Options{Logger: logger, ResourceID: testResourceID, MCP: stub, Feed: stub}},
		{"no mcp", Options{Logger: logger, ResourceID: testResourceID, AuthServer: testAuthServer, Feed: stub}},
		{"no feed", Options{Logger: logger, ResourceID: testResourceID, AuthServer: testAuthServer, MCP: stub}},
	}
